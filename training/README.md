...
->An MLP probe training script, and an output linear probe, which predicts if an output harmful will be likely generated 
from the input. Both were outperformed by the LP and therefore not included in the paper.

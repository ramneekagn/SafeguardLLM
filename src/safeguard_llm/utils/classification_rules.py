...
def classify_any_rule(input_disapprovals: Collection[dict[str, Any]],internal_disapprovals: Collection[list[dict[str, Any]]], output_disapprovals: Collection[list[dict[str, Any]]]):
    overall_disapproval = (
        any(v["disapproved"] for v in input_disapprovals) and 
        any(v["disapproved"] for v in internal_disapprovals) and 
